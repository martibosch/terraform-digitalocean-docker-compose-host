...
| `compose_app_dir`                                     | Local path to the application directory from which docker-compose will be exectued, which will be synched with the droplet at `droplet_app_dir`.         | `string`                                                               | `./init.sh`        | no                              |
